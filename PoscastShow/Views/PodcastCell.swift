...
class PoscastCell: UITableViewCell {
  ...
  private func setupUI() {
    ...
    stackViewLabel.topAnchor.constraint(equalTo: podcastImageView.topAnchor).isActive = true
    stackViewLabel.bottomAnchor.constraint(equalTo: podcastImageView.bottomAnchor).isActive = true
